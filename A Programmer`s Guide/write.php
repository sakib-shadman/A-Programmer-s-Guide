...
<ul>
      ...
      <div id="content">
		...
		<br><br><pre><h5 style="font-size:15px">                          Heading</h5></pre>
			
        <form action="process/tutorial_process.php" method="post" >
		<textarea name="heading" cols="50" rows="2"  style="border-radius:10px; border-color: blue"></textarea><br><br>
		
		<br><br><pre><h5 style="font-size:15px">                          Description</h5></pre>
		
		<textarea name="description" cols="50" rows="10"  style="border-radius:10px; border-color: blue"></textarea><br><br><br>
				<br><pre><h5 style="font-size:15px">                Algorithm/Procedure</h5></pre>
				<textarea name="algorithm" cols="50" rows="5"  style="border-radius:10px; border-color: blue"></textarea><br><br><br>
				<br><pre><h5 style="font-size:15px">                Code</h5></pre>
				<br><textarea name="code" cols="50" rows="2"  style="border-radius:10px; border-color: blue"></textarea><br><br>
		<pre>  <input  type="submit" value="Upload Tutorial"   style="border-radius:5px; border-color: blue;width:350px"/></pre>
      </form>	  
