            ...
            <div class="section1_middle">
			  ...
			  <?php
				if(isset($_SESSION['user_id']))
				{
					...
					echo '<li><a href="basic prg.php">&raquo; Basic Programming</a></li>';
				    echo '<li><a href="Programming in OOP style.php">&raquo; Programming in OOP style</a></li>';
					echo '<li><a href="http://www.w3schools.com/">&raquo; Make your own Website</a></li>';
					echo '<li><a href="code.php">&raquo; Code Example</a></li>';
				}
				else
				{
				   echo '<li><a href="" onclick="myFunction()">&raquo; Algorithms</a></li>';
				   echo '<li><a href="" onclick="myFunction()">&raquo; Basic Programming</a></li>';
				    echo '<li><a href="" onclick="myFunction()">&raquo; Programming in OOP style</a></li>';
					echo '<li><a href="" onclick="myFunction()">&raquo; Make your own Website</a></li>';
    ...
    <?php
          ...
          <div class="section">
            ...
            <div class="section3_middle">
              <h2>Quick Links</h2>
              <ul>
               <li><a href="http://uva.onlinejudge.org/" target="_blank">&raquo; Uva Online Judge</a></li>
                <li><a href="http://codeforces.com/" target="_blank">&raquo; Codeforces.com</a></li>
                <li><a href="http://uva.onlinejudge.org/" target="_blank">&raquo; Light Oj</a></li>
                <li><a href="http://www.cplusplus.com/" target="_blank">&raquo; C++.com</a></li>
                <li><a href="http://www.w3schools.com/" target="_blank">&raquo; W3School.com</a></li>
              </ul>
            </div>
