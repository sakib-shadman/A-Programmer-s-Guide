...
<ul>
      ...
      <div id="content">
        <div id="left_column">
          <div class="postbody">
            <h1>Learn Java through Videos:</h1>
			<br>
			<p>
			
			<video id="vd1" width="280" height="280"  controls>
  <source src="videos/Java Programming Tutorial - 3 - Downloading Eclipse - YouTube.mp4" type="video/mp4">
</video>

	<video id="vd1" width="280" height="280"  controls>
  <source src="videos/Java Programming Tutorial - 2 - Running a Java Program - YouTube.mp4" type="video/mp4">
</video>

	<video id="vd1" width="280" height="280"  controls>
  <source src="videos/Java Programming Tutorial - 4 - Hello YouTube - YouTube.mp4" type="video/mp4">
</video>

	<video id="vd1" width="280" height="280"  controls>
  <source src="videos/Java Programming Tutorial - 5 - Variables - YouTube.mp4" type="video/mp4">
</video>

	<video id="vd1" width="280" height="280"  controls>
  <source src="videos/Java Programming Tutorial - 11 - Logical Operators - YouTube.mp4" type="video/mp4">
</video>
	<video id="vd1" width="280" height="280"  controls>
  <source src="videos/Java Programming Tutorial - 25 - Math Class Methods - YouTube.mp4" type="video/mp4">
</video>
			</p>
