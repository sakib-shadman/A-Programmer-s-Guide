...
<p>Quicksort is a divide and conquer algorithm. Quicksort first divides a large array into two smaller sub-arrays: the low elements and the high elements. Quicksort can then recursively sort the sub-arrays.
<br>
The steps are:<br>
...
<!--End of shadmans blog-->
          ...
          <div class="postbody">
           ...
           <div class="comment"  ><a href="ss2.php">Comments</div>
			 <br><br>
			 <?php
