...
?>
						<div class="tab-content" style="height:300px;width:300px"> 
							<p id="pr"><a href="<?php echo $link1; ?>" style="color:white"><p ><?php echo $status1; ?></p></a> </p></p>
...
<?php
while($rowq=mysql_fetch_array($res))
{
$user_id= $rowq['user_id'];
$status2= $rowq['comment'];
$link2= $row['link'];


?>
						<div class="tab-content" style="height:300px;width:300px"> 
						<p id="pr"><a href="<?php echo $link2; ?>" style="color:white"><p ><?php echo $status2; ?></p></a> </p></p>
  ...
  <li><a href="<?php echo $row['headings']; ?>">&raquo;<?php echo $row['description'];?></a></li>
    ...
    <?php
      ...
      <div id="footer"> 
        ...
        <form action="process/notice_process.php" method="post" style="position:absolute;top:1000px;left:380px">
		 <input type="checkbox" name="contest" value="contest"/> <label for="contest" style="color:white">contest</label> 
		 <input type="checkbox" name="course" value="online course"/> <label for="online course" style="color:white">online course</label> 
		 <input type="checkbox" name="others" value="others"/> <label for="others" style="color:white">others</label> 
		<br><textarea name="comment" cols="50" rows="2"  ></textarea>
		<br><textarea name="link" cols="50" rows="2"  ></textarea>
		<br><input  type="submit" value="Upload notice" />
      </form>
